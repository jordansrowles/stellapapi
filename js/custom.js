	...
	*/
	...
	function initAlbumPlayer()
	{
		if($('#jplayer_1').length)
		{
			...
			[
				{
					title:"1. Stella Poetry",
					artist:"Bensound",
					mp3:"files/stellapapi.mp3",
					duration:"2.33"
				},
				{
					title:"2. Papi's Home",
				...
				{
					title:"4. Brother-Lover",
					artist:"Bensound",
					mp3:"files/stellapapi.mp3",
					duration:"2.04"
				},
				{
					title:"6. Bored (ft. 50 Cent)",
					artist:"Bensound",
					mp3:"files/stellapapi.mp3",
					duration:"2.20"
				},
				{
					title:"12. The Gayle Is Mine",
					artist:"Bensound",
					mp3:"files/stellapapi.mp3",
					duration:"2.20"
				},
				{
					title:"14. Buy You A Stella (ft. T-Pain & Akon)",
					artist:"Bensound",
					mp3:"files/stellapapi.mp3",
					duration:"2.33"
				},
				{
					title:"17. Brendon & My Sister",
					artist:"Bensound",
					mp3:"files/stellapapi.mp3",
					duration:"2.04"
				},
